...
TEST(SignTest, TestLoadInvalidPemKeys)
{
    ...
    pkey = load_private_key(bio_private_key, KEY_FORMAT_PEM, nullptr);
    ASSERT_EQ(pkey, nullptr);
    pkey = load_public_key(bio_public_key, KEY_FORMAT_PEM, nullptr);
    ASSERT_EQ(pkey, nullptr);
...
TEST(SignTest, TestLoadInvalidPkcs12PrivateKey)
{
    ...
    pkey = load_private_key(bio_private_key, KEY_FORMAT_PKCS12, nullptr);
    ASSERT_EQ(pkey, nullptr);
    pkey = load_public_key(bio_public_key, KEY_FORMAT_PKCS12, nullptr);
    ASSERT_EQ(pkey, nullptr);
...
TEST(SignTest, TestLoadValidPemKeys)
{
    ...
    // Read back the keys
    private_key_enc_read = load_private_key(bio_private_key_enc,
                                            KEY_FORMAT_PEM, "testing");
    ASSERT_NE(private_key_enc_read, nullptr);
    private_key_noenc_read = load_private_key(bio_private_key_noenc,
                                              KEY_FORMAT_PEM, nullptr);
    ASSERT_NE(private_key_noenc_read, nullptr);
    public_key_read = load_public_key(bio_public_key,
                                      KEY_FORMAT_PEM, "testing");
...
TEST(SignTest, TestLoadValidPemKeysWithInvalidPassphrase)
{
    ...
    private_key_read = load_private_key(bio, KEY_FORMAT_PEM, "gnitset");
